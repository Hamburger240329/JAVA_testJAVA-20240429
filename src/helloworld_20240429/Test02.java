...
public class Test02 {
	...
	public static void main(String[] args) {
		...
		String str1 = "3" + 10;
		System.out.println(str1);  // 문자열 + 정수를 연산하면 양쪽다 문자열로 변환한 후 결합시켜버림
		
		String numStr1 = "10";
		
		// int numInt1 = (int)numStr1;  // 파이썬 문법 - 파이썬에서는 가능하나 자바에서는 불가!
		// 문자열을 바로 정수로 변환 불가
		
		int numInt1 = Integer.parseInt(numStr1);  // 문자열 -> 정수로 변환하는 방법!!!
		
		String numStr2 = "3.14";
		double numDouble = Double.parseDouble(numStr2);  // 문자열 -> 실수로 변환
